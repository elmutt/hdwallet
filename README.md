...
```bash
yarn add @elmutt/hdwallet-core
yarn add @elmutt/hdwallet-keepkey-webusb
yarn add @elmutt/hdwallet-trezor-connect
yarn add @elmutt/hdwallet-ledger-webusb
```
...
```javascript
import { HDWallet } from "@elmutt/hdwallet-core";
import { isKeepKey, KeepKeyHDWallet } from "@elmutt/hdwallet-keepkey";
import { isLedger, LedgerHDWallet } from "@elmutt/hdwallet-ledger";
import { isTrezor, TrezorHDWallet } from "@elmutt/hdwallet-trezor";
